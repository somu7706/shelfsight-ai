...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      inventory_forecasts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "inventory_forecasts_shop_id_fkey"
            columns: ["shop_id"]
            isOneToOne: false
            referencedRelation: "shops"
            referencedColumns: ["id"]
      ...
      vision_detections: {
        ...
        Relationships: [
          {
            foreignKeyName: "vision_detections_product_id_fkey"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "vision_detections_shop_id_fkey"
            columns: ["shop_id"]
            isOneToOne: false
            referencedRelation: "shops"
            referencedColumns: ["id"]
    ...
    Enums: {
      app_role: "owner" | "staff" | "customer" | "admin"
    }
    CompositeTypes: {
      [_ in never]: never
    }
